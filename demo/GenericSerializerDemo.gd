...
func demo_3_mixed_approaches():
	...
	var poison = DemoStatusEffect.new(1, "Poison", {"damage": 5})
	var hero = DemoCharacter.new("Hero", 100, [poison])
	...
	print("Original data:")
	print("  Player: ", game_data["player_character"].char_name)
	...
	print("\nRestored data:")
	print("  Player: ", restored["player_character"].char_name, " (HP: ", restored["player_character"].hp, ")")
	print("  Player has to_dict: ", restored["player_character"] is DemoCharacter)
...
func demo_performance():
	...
	for i in range(iterations):
		var char = DemoCharacter.new("Test", 100, [])
